...
public class PrismaBelahKetupat extends BelahKetupat {
    ...
    public double hitungLuasPermukaan(double d1Baru, double d2Baru, double tinggiPrismaBaru) {
        double luasAlas = super.hitungLuas(d1Baru, d2Baru);
        double luasSelimut = super.hitungKeliling(d1Baru, d2Baru) * tinggiPrismaBaru;
        luasPermukaan = 2 * luasAlas + luasSelimut;
        return luasPermukaan;
    }
