...
public class KerucutTerpancung extends Kerucut {
    private double r2,volume,luasPermukaan;
    ...
    public double hitungVolume() {
        double r1 = jariJari;
        double h = tinggi;
        this.volume = (1.0 / 3.0) * Math.PI * h * (Math.pow(r1, 2) + (r1 * r2) + Math.pow(r2, 2));
        return volume;
    }
    ...
    public double hitungLuasPermukaan() {
        ...
        this.luasPermukaan = luasAlasBawah + luasAlasAtas + luasSelimut;
    ...
    public double hitungVolume(double jariJariBaru, double r2Baru, double tinggiBaru) {
        ...
        double h = tinggiBaru;
        this.volume = (1.0 / 3.0) * Math.PI * h * (Math.pow(r1, 2) + (r1 * r2Baru) + Math.pow(r2Baru, 2));
        return volume;
    }
